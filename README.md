...
### Why wonÅft DivaModManager open?
I made it so only one instance is running at a time so if itÅfs already running, the app wonÅft open. Check to see if you can end the process in task manager or even restart your pc if you donÅft know how to do that. 
